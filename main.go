...
<head>
  ...
  <style>
    :root {
      ...
      --muted: #8fc6ab;
      --neon: #34f5a2;
      --neon-soft: rgba(52, 245, 162, 0.22);
      --card-border: rgba(104, 255, 189, 0.2);
      --box-bg: rgba(16, 38, 30, 0.72);
    }
    * { box-sizing: border-box; }
    body{
      ...
      color:var(--fg);
      background:
        radial-gradient(1200px 700px at 15% -10%, rgba(35, 183, 121, 0.17), transparent 65%),
        radial-gradient(900px 500px at 90% 10%, rgba(24, 130, 88, 0.16), transparent 65%),
    ...
    .card{
      ...
      box-shadow:
        0 0 0 1px rgba(78, 235, 160, 0.06) inset,
        0 16px 36px rgba(0, 0, 0, 0.35),
        0 0 24px rgba(52, 245, 162, 0.08);
      backdrop-filter: blur(4px);
    }
    h1{
      margin:0 0 8px 0;
      color:#c8ffe1;
      text-shadow:0 0 14px rgba(52, 245, 162, 0.24);
    }
    h2{
      color:#b9f8d6;
      margin-top:20px;
    ...
    a{
      ...
      border-bottom:1px dotted rgba(154, 250, 208, 0.55);
      transition:color .2s ease,border-color .2s ease,text-shadow .2s ease;
    }
    a:hover{
      color:#c8ffe8;
      border-color:rgba(200,255,232,.95);
      text-shadow:0 0 10px rgba(52,245,162,.35);
    }
    code{
      background:rgba(10, 36, 27, 0.9);
      border:1px solid rgba(74, 217, 152, 0.24);
      color:#d3ffe7;
      padding:2px 7px;
      border-radius:7px;
    }
    ...
    .box{
      ...
      border:1px solid rgba(95, 246, 176, 0.2);
      border-radius:12px;
      padding:14px;
      margin-top:16px;
    ...
    @keyframes pulseGlow {
      0%,100% { box-shadow:0 0 10px rgba(52,245,162,0.12); }
      50% { box-shadow:0 0 22px rgba(52,245,162,0.2); }
    }
    @keyframes backgroundDrift {
      from { filter: saturate(95%); }
