...
func defaultConfig(dataDir string) Config {
	...
	return Config{
		...
		Repos: []Repo{
			{Name: "archlinux", Remote: "rsync://mirror.init7.net::archlinux", LocalSubdir: "archlinux", Enabled: true},
			{Name: "almalinux", Remote: "rsync://mirror.init7.net::almalinux", LocalSubdir: "almalinux", Enabled: true},
			{Name: "debian", Remote: "rsync://mirror.init7.net::debian", LocalSubdir: "debian", Enabled: true},
			{Name: "debian-cd", Remote: "rsync://mirror.init7.net::debian-cd", LocalSubdir: "debian-cd", Enabled: true},
			{Name: "debian-security", Remote: "rsync://mirror.init7.net::debian-security", LocalSubdir: "debian-security", Enabled: true},
			{Name: "ubuntu", Remote: "rsync://mirror.init7.net::ubuntu", LocalSubdir: "ubuntu", Enabled: true},
			{Name: "ubuntu-releases", Remote: "rsync://mirror.init7.net::ubuntu-releases", LocalSubdir: "ubuntu-releases", Enabled: true},
		},
	}
}
